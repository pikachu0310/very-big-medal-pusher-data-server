...
type SaveDataV2 struct {
	...
	LPerksCredit   *[]int          `json:"l_perks_credit,omitempty" table:"save_data_v2_perks_credit"`
	...
	PalballGet     *int            `db:"palball_get" json:"palball_get,omitempty"`
	PallotLotT0    *int            `db:"pallot_lot_t0" json:"pallot_lot_t0,omitempty"`
	PallotLotT1    *int            `db:"pallot_lot_t1" json:"pallot_lot_t1,omitempty"`
	PallotLotT2    *int            `db:"pallot_lot_t2" json:"pallot_lot_t2,omitempty"`
	PallotLotT3    *int            `db:"pallot_lot_t3" json:"pallot_lot_t3,omitempty"`
	...
	TaskCnt        *int            `db:"task_cnt" json:"task_cnt,omitempty"`
